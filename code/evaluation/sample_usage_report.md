...
**Generated At:** 2026-09-13 16:29:26  
**Run Scope:** Full Dataset Evaluation (25 requests)
...
| Total Evaluated Requests | 25 |
| High-Confidence Regex/NLP Matches | 25 (100% dataset resolution) |
...
For evaluator comparison, if all 25 requests had bypassed local parsing and invoked external models directly:

| Metric Dimension | Zero-Token Optimized (Actual) | Full-LLM Invocation (Projected) |
|---|---|---|
| External Model Calls | **0** | 25 |
| Input Tokens | **0** | ~1,625 |
| Output Tokens | **0** | ~400 |
| **Total Tokens** | **0** | **~2,025** |
| Total Estimated Cost | **$0.000000** | **~$0.000484** |
